    ...
    <header className={props.colorClass}>
      ...
      {props.loggedIn ? (
        <>
          ...
          <div className="header__profile-link">
            ...
            <div className="header__profile-link__placeholder">
              <img
                className="header__profile-link__icon"
                src={iconPath}
        ...
        <div className="header__registration-menu">
          <Link to={"/signup"} className="header__registration-menu__register">
            Регистрация
          </Link>
          <Link to={"/signin"} className="header__registration-menu__signin">
            Войти
          </Link>
        </div>
      )}
